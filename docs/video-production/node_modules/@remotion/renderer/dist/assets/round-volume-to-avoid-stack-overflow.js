...
exports.roundVolumeToAvoidStackOverflow = exports.MAX_FFMPEG_STACK_DEPTH = void 0;
exports.MAX_FFMPEG_STACK_DEPTH = 98;
const roundVolumeToAvoidStackOverflow = (volume) => {
    return Number((Math.round(volume * (exports.MAX_FFMPEG_STACK_DEPTH - 1)) /
        (exports.MAX_FFMPEG_STACK_DEPTH - 1)).toFixed(3));
};
