...
const segments = [
  // 开场 (15秒)
  { text: "2026年，AI正在杀死程序员！", type: "标题", duration: 8 },
  { text: "不是AI要取代程序员，而是会用AI的程序员正在取代不会用AI的程序员！", type: "开场", duration: 10 },
  
  // 现状 (30秒)
  { text: "AI编程工具爆发！2026年，这些工具正在改变编程！", type: "干货", duration: 10 },
  { text: "Claude Code、Cursor、v0、Devin...每一个都是革命性的工具！", type: "干货", duration: 12 },
  { text: "GitHub Copilot企业版全面升级，代码生成率超过50%！", type: "干货", duration: 12 },
  
  // 数据展示 (40秒)
  { text: "AI编程效率提升数据！简单Web页面：4小时→10分钟，提升24倍！", type: "数据", duration: 12 },
  { text: "REST API开发：8小时→30分钟，16倍提升！小程序：2天→2小时！", type: "数据", duration: 12 },
  { text: "Bug修复：2小时→5分钟，单元测试：4小时→10分钟，全是24倍！", type: "数据", duration: 12 },
  
  // 案例 (30秒)
  { text: "真实案例！某互联网公司裁掉50%基础程序员，效率反而提升！", type: "案例", duration: 12 },
  { text: "一个初级程序员+AI工具，效率超过5个高级程序员！", type: "案例", duration: 12 },
  
  // 工具对比 (40秒)
  { text: "AI编程工具对比！Claude Code：端到端开发，自主决策！", type: "工具", duration: 12 },
  { text: "Cursor：智能代码补全，推荐下一个token！v0：前端生成神器！", type: "工具", duration: 12 },
  { text: "Devin：第一个AI软件工程师，自主完成整个项目！", type: "工具", duration: 12 },
  
  // 生存指南 (40秒)
  { text: "程序员生存指南！这些岗位正在消失：CRUD开发、简单页面、基础测试！", type: "干货", duration: 12 },
  { text: "不容易被替代的：系统架构师、AI工程师、安全工程师、技术管理！", type: "干货", duration: 12 },
  { text: "核心能力：复杂问题分析、系统设计、创新方案、团队协作！", type: "干货", duration: 12 },
  
  // 行动建议 (30秒)
  { text: "立即行动！每天学习1小时AI编程工具，3个月后甩开90%的人！", type: "行动", duration: 12 },
  { text: "推荐学习路线：Python基础→ChatGPT→Claude→Cursor→自己开发Agent！", type: "行动", duration: 12 },
  
  // 金句+CTA (20秒)
  { text: "记住！AI不会杀死程序员，但会杀死不会AI的程序员！", type: "金句", duration: 10 },
  { text: "点赞收藏关注，下期讲如何用AI做副业月入过万！", type: "CTA", duration: 8 }
];
...
async function run() {
  ...
  for (let i = 0; i < segments.length; i++) {
    ...
    console.log(`  段${i+1}: ${segments[i].duration}秒 - ${segments[i].text.substring(0,35)}...`);
  }
  console.log("");
  ...
  for (let i = 0; i < segments.length; i++) {
    ...
    else if (seg.type === "行动") html = templates.行动(seg.text);
